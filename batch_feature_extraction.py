...
def FeatureExtraction(params_dict):

    process_str = params_dict['process_str']

    if 'dev' in process_str:
        # -------------- Extract features and labels for development set -----------------------------
        dev_feat_cls = cls_feature_class.FeatureClass(params_dict, is_eval=False)
    ...
    if 'eval' in process_str:
        ...
        eval_feat_cls = cls_feature_class.FeatureClass(params_dict, is_eval=True)
