...
# INPUT DIRECTORY
ref_desc_files = '/Datasets/metadata_dev'  # reference description directory location
pred_output_format_files = 'results/1_foa_dev'  # predicted output format directory location
...
for score_type in score_type_list:
    ...
    for split_key in np.sort(list(split_cnt_dict)):
        ...
        eval = SELD_evaluation_metrics.SELDMetrics(nb_classes=feat_cls.get_nb_classes(),
        ...
        for pred_cnt, pred_file in enumerate(split_cnt_dict[split_key]):
            ...
            gt_dict_polar = feat_cls.load_output_format_file(os.path.join(ref_desc_files,
        ...
        print('\nAverage score for {} {} data using {} coordinates'
              .format(score_type, 'fold' if score_type == 'all' else split_key,
